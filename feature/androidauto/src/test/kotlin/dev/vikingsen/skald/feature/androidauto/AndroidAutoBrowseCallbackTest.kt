package dev.vikingsen.skald.feature.androidauto
...
import dev.vikingsen.skald.core.player.AudiobookSessionCallback
...
import dev.vikingsen.skald.feature.androidauto.R
import io.mockk.*
...
class AndroidAutoBrowseCallbackTest {
    ...
    fun setUp() {
        ...
        every { context.packageName } returns "dev.vikingsen.skald"
